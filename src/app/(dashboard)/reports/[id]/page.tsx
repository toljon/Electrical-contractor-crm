    ...
    <div className="p-4 md:p-8 max-w-5xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Link href={`/reports/${id}/readings`}>
          <Card className="hover:shadow-md transition-shadow cursor-pointer border-brand/30 hover:border-brand">
            <CardContent className="py-6 flex items-center gap-4">
              <div className="bg-brand-wash rounded-lg p-3">
                <ClipboardList className="h-6 w-6 text-brand-ink" />
              </div>
              <div>
        ...
        <Link href={`/reports/${id}/findings`}>
          <Card className="hover:shadow-md transition-shadow cursor-pointer border-brand/30 hover:border-brand">
            <CardContent className="py-6 flex items-center gap-4">
              <div className="bg-brand-wash rounded-lg p-3">
                <AlertTriangle className="h-6 w-6 text-brand-ink" />
              </div>
              <div>
