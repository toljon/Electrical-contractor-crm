...
// Consolidated TGG Ops schema (SQLite dialect) — equivalent of the final
// state of supabase/migrations/001–003, with auth folded into a local
// `users` table. Org scoping (formerly RLS) is enforced in engine.ts.
const SCHEMA = `
